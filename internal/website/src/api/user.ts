...
export function listUsers(params?: { limit?: number; cursor?: string; search?: string; department_id?: number }) {
...
export function listFollowing(username: string, params?: { limit?: number; cursor?: string }) {
