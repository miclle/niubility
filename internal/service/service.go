...
func New(ctx context.Context, driver, dsn string) (*Service, error) {
	...
	if err := db.WithContext(ctx).AutoMigrate(&entity.User{}, &entity.Content{}, &entity.Attachment{}, &entity.Setting{}, &entity.Department{}, &entity.Comment{}, &entity.Like{}, &entity.Category{}, &entity.Follow{}, &entity.Favorite{}); err != nil {
