...
type Like struct {
	...
	UserID     string     `json:"user_id"     gorm:"column:user_id;uniqueIndex:uniq_likes_user_target"`
	TargetID   string     `json:"target_id"   gorm:"column:target_id;uniqueIndex:uniq_likes_user_target"`
	TargetType TargetType `json:"target_type" gorm:"column:target_type;uniqueIndex:uniq_likes_user_target"`
